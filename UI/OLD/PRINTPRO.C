...
HWND PrintCutWin[20];
int SetPrintPara(void);
int GetPrintPara(void);
...
unsigned long PrP2(HWND Window,HMSG Message,long Param1,long Param2)
{
...
unsigned long PrP3(HWND Window,HMSG Message,long Param1,long Param2)
{
...
unsigned long PrP4(HWND Window,HMSG Message,long Param1,long Param2)
{
...
unsigned long PrP5(HWND Window,HMSG Message,long Param1,long Param2)
{
...
unsigned long PrP6(HWND Window,HMSG Message,long Param1,long Param2)
{
    if (Message==WINDOWINIT) PrintCutWin[6]=Window;
    return(SingleLineEditorDefaultProcedure(Window,Message,Param1,Param2));
}
unsigned long PrP7(HWND Window,HMSG Message,long Param1,long Param2)
{
    if (Message==WINDOWINIT) PrintCutWin[7]=Window;
    return(SingleLineEditorDefaultProcedure(Window,Message,Param1,Param2));
}
unsigned long PrP8(HWND Window,HMSG Message,long Param1,long Param2)
{
    if (Message==WINDOWINIT) PrintCutWin[8]=Window;
    return(SingleLineEditorDefaultProcedure(Window,Message,Param1,Param2));
}
unsigned long PrP9(HWND Window,HMSG Message,long Param1,long Param2)
{
    if (Message==WINDOWINIT) PrintCutWin[9]=Window;
    return(SingleLineEditorDefaultProcedure(Window,Message,Param1,Param2));
}

unsigned long PrP10(HWND Window,HMSG Message,long Param1,long Param2)
{
    if (Message==WINDOWINIT) PrintCutWin[10]=Window;
    return(SingleLineEditorDefaultProcedure(Window,Message,Param1,Param2));
}

unsigned long PrP11(HWND Window,HMSG Message,long Param1,long Param2)
{
...
Dialogs PrintCutDialog[]=
{
  ...
  { USERBUTTONITEM, 0, 9, 200, 81,228, ADDWIN, NULL, " 增  加 " },
  { USERBUTTONITEM, 0, 9, 238, 81,266, DELETEWIN, NULL, " 删  除 " },
  { USERBUTTONITEM, 0, 9, 276, 81,304, DELETETAILWIN, NULL, "删除至尾" },
  { USERBUTTONITEM, 0, 9, 314, 81,342, COPYWIN, NULL, "自动复制" },
